...
fun UpdateCard(
    ...
    val date by viewModel.updateDate.collectAsState()
    val location by viewModel.updateLocation.collectAsState()
    val description by viewModel.updateDescription.collectAsState()
    val rating by viewModel.updateRatingBar.collectAsState()
        ...
        Column(
            ...
            Row {
                ...
                RatingBar(
                    ...
                    onRatingChanged = { viewModel.updateRatingBar(it) }
                )
            }
        }
    }
